...
namespace {
    ...
    // @codingStandardsIgnoreLine Because `require`
    require __DIR__ . DS . '..' . DS . '..' . DS . '..' . DS . '..' . DS . '..' . DS . 'backwards-compatibility.php';
}
...
namespace Siment\HttpHeaderThemeSwitch\Test\Plugin\Magento\Framework\View {
    ...
    /*
     * Ignoring because PHPCS complains that `use` statements should go immediately
     * after first namespace declaration. I need the global namespace to be parsed
    ...
    class DesignExceptionsTest extends \PHPUnit\Framework\TestCase
    {
        ...
        /**
         * Tests for DesignExceptionsPlugin::afterGetThemeByRequest
         *
         * @param string        $scenario
         * @param string|false  $result
         * @param array|false   $expressions
         * @param array|string  $deviceHeader
         * @see DesignExceptionsPlugin::afterGetThemeByRequest
         * @dataProvider afterGetThemeByRequestDataProvider
         */
         ...
         * @return array
         */
        public function afterGetThemeByRequestDataProvider()
        {
            $return = [
                [
